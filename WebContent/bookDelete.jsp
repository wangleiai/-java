...
<body id="body" class="wide-layout preloader-active">
						...
						<div class="cart-wrapper">
							...
							<table id="cart_list" class="cart-list mb-30">
								...
								<tbody>
									<!-- 这里用for循环 -->
									<%
										ArrayList cArrayList = (ArrayList) session.getAttribute("books");
									...
									<tr class="panel alert">
										...
										<td>
											<button type="button" onclick="deleteFrom(<%=i%>)">
	...
	<script type="text/javascript">
		function deleteFrom(i) {
			/* alert(i); */
			$.ajax({
					url: "/bookShopping/DoDelete",
					type: "post",
					data: {
						"index":i,
					...
					success: function (msg) {
						...
						if(flag=="true"){
							alert("删除成功");
							window.location.href="http://localhost:8080/bookShopping/BookDelete";
							}
						else{
							alert("删除失败");
							}
